  ...
  def performAnsibleDeployment(mavenBuildEngine){
   ...
   if(mavenBuildEngine.buildFile==null || mavenBuildEngine.buildFile==""){
	...
	//  instance_name: ${instance_name} '''
	  , importTowerLogs: true, importWorkflowChildLogs: true, inventory: '', jobTags: '', jobTemplate: 'VMCloudbeesDeploy_HelloWorld', jobType: 'run', limit: '', removeColor: true, skipJobTags: '', templateType: 'workflow', throwExceptionWhenFail: true, towerServer: 'AnsibleTower', verbose: true
