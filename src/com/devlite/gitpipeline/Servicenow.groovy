...
class Servicenow implements Serializable { 
  ...
  steps.echo '**********Checkout the code from GIT Started**********'
     ...
     //    steps.echo ' ' + build_description + '' 
          def request= steps.ChangeRequest assignedTo:'Ansible Integrations',category:'Other',ci:'AS400',impact:'3 - Low',fullDescription: build_description,Description: "testing",priority:'4 - Low',requestedBy:'Ansible Integrations',risk:'Moderate',shortDescription:"testing",state:'New',type:'Standard'
